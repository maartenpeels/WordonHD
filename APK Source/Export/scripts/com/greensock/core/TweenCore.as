package com.greensock.core
{
   ...
   public class TweenCore extends Object
   {
      ...
      public function TweenCore(param1:Number = 0, param2:Object = null)
      {
         ...
         _delay = this.vars.delay?Number(this.vars.delay):0.0;
         this.cachedTimeScale = this.vars.timeScale?Number(this.vars.timeScale):1.0;
      ...
      public function restart(param1:Boolean = false, param2:Boolean = true) : void
      {
         this.reversed = false;
         this.paused = false;
         this.setTotalTime(param1?-_delay:0.0,param2);
      }
