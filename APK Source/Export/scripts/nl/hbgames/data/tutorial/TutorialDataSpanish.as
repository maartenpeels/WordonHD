package nl.hbgames.data.tutorial
{
   ...
   public class TutorialDataSpanish extends BaseTutorialData
   {
       
      public function TutorialDataSpanish()
      {
         super();
      }
      ...
      override public function Get(param1:int) : Object
      {
               ...
               if(_loc2_ !== _loc4_)
               {
                  ...
                  if(_loc2_ !== _loc4_)
                  {
                     ...
                     if(_loc2_ !== _loc4_)
                     {
                        ...
                        if(_loc2_ !== _loc4_)
                        {
                           ...
                           if(_loc2_ !== _loc4_)
                           {
                              ...
                              if(_loc2_ !== _loc4_)
                              {
                                 ...
                                 if(_loc2_ !== _loc4_)
                                 {
                                    ...
                                    if(_loc2_ !== _loc4_)
                                    {
                                          ...
                                          if(_loc2_ !== _loc4_)
                                          {
                                             ...
                                             if(_loc2_ !== _loc4_)
                                             {
                                                ...
                                                if(_loc2_ !== _loc4_)
                                                {
                                                   ...
                                                   {
                                                      delete _loc3_.session;
                                                      _loc3_.actions.requiredWord = "TORPEZA";
                                                      _loc3_.actions.message = CreateMessage(1,Localization.Get("tutorial_step_14",58,5),0.3,0,-150);
                                                   }
                                                }
                                                else
                                                {
                                             ...
                                             {
                                                delete _loc3_.session;
                                                _loc3_.actions.message = CreateMessage(2,Localization.Get("tutorial_step_12","PORTE"),0.3,0,-150);
                                             }
                                          }
                                          else
                                          {
                                             delete _loc3_.session;
                                             _loc3_.actions.requiredWord = "PORTE";
                                             _loc3_.actions.checkBeforePlay = true;
                                       ...
                                       else
                                       {
                                          ...
                                          _loc3_.actions.message = CreateMessage(1,Localization.Get("tutorial_step_10",3),0.3,0,-100);
                                       }
                                    }
                                    else
                                    {
                                       delete _loc3_.session;
                                       _loc3_.actions.requiredWord = "RATEO";
                                       _loc3_.actions.checkBeforePlay = true;
                                 ...
                                 {
                                    _loc3_.session.yourWordons = "!P,!T";
                                    _loc3_.session.yourLetters = "E,R,N,Z,R,A,O";
                                    _loc3_.session.yourScore = 16;
                                    _loc3_.session.yourGrid = [0,1,0,3,3,0,4];
                                    _loc3_.session.otherScore = 5;
                                    _loc3_.session.otherGrid = [3,0,0,3,0,1,4];
                                    _loc3_.session.lastScore = 5;
                                    _loc3_.session.lastWord = "P,O,E,T,A";
                                    _loc3_.session.lastGrid = [0,3,3,0,0,1,4];
                                    _loc3_.session.tiles = 10;
                                    _loc3_.actions.message = CreateMessage(2,Localization.Get("tutorial_step_8","POETA",5),1,0,-100);
                                 }
                              }
                              else
                              {
                        ...
                        {
                           _loc3_.session.otherWordons = "!S,!O";
                           _loc3_.session.yourLetters = "E,R,N,Z,R,A,O";
                           _loc3_.session.yourScore = 16;
                           _loc3_.session.yourGrid = [0,1,0,3,3,0,4];
                           _loc3_.session.otherScore = 0;
                           _loc3_.session.otherGrid = [3,0,0,3,0,1,4];
                           _loc3_.session.lastScore = 16;
                           _loc3_.session.lastWord = "O,B,E,S,O";
                           _loc3_.session.lastGrid = [3,0,1,3,0,0,4];
                           _loc3_.session.coinsWon = 4;
                           _loc3_.session.tiles = 15;
                           _loc3_.actions.message = CreateMessage(2,Localization.Get("tutorial_step_6","O","S"),4.5,0,100);
                        }
                     }
                     else
                     {
                        delete _loc3_.session;
                        _loc3_.actions.requiredWord = "OBESO";
         ...
         else
         {
            ...
            _loc3_.session.yourLetters = "B,O,D,E,R,S,O";
