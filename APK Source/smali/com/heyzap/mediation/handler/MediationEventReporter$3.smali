...
.method constructor <init>(Lcom/heyzap/mediation/handler/MediationEventReporter;Lcom/heyzap/internal/ListenableFuture;Ljava/util/Map;)V
    ...
    iput-object p3, p0, Lcom/heyzap/mediation/handler/MediationEventReporter$3;->val$baseParams:Ljava/util/Map;
...
.method public run(Ljava/lang/Boolean;Ljava/lang/Exception;)V
    ...
    .line 59
    iget-object v0, p0, Lcom/heyzap/mediation/handler/MediationEventReporter$3;->this$0:Lcom/heyzap/mediation/handler/MediationEventReporter;

    new-instance v1, Lcom/heyzap/http/RequestParams;

    iget-object v2, p0, Lcom/heyzap/mediation/handler/MediationEventReporter$3;->val$baseParams:Ljava/util/Map;

    invoke-direct {v1, v2}, Lcom/heyzap/http/RequestParams;-><init>(Ljava/util/Map;)V

    # invokes: Lcom/heyzap/mediation/handler/MediationEventReporter;->onIncentiveComplete(Lcom/heyzap/http/RequestParams;Ljava/lang/Boolean;)V
...
.method public bridge synthetic run(Ljava/lang/Object;Ljava/lang/Exception;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/heyzap/mediation/handler/MediationEventReporter$3;->run(Ljava/lang/Boolean;Ljava/lang/Exception;)V
