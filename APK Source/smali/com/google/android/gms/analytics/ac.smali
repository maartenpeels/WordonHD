...
.method private a(Ljava/util/Map;Ljava/util/Collection;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/ef;->getValue()Ljava/lang/String;
...
.method static w(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/google/android/gms/analytics/y;->encode(Ljava/lang/String;)Ljava/lang/String;
...
.method b(Ljava/util/Collection;)V
    ...
    :cond_2
    invoke-virtual {p0, v1}, Lcom/google/android/gms/analytics/ac;->a([Ljava/lang/String;)V
...
.method public bW()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/analytics/n;->ch()Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/analytics/ac;->t(I)Ljava/util/List;
    ...
    invoke-interface {v0, v3}, Lcom/google/android/gms/analytics/e;->r(Z)V

    goto :goto_0

    :cond_1
    iget-object v1, p0, Lcom/google/android/gms/analytics/ac;->vB:Lcom/google/android/gms/analytics/ab;

    if-nez v1, :cond_2

    new-instance v1, Lcom/google/android/gms/analytics/ab;

    const-string v2, "_t=dispatch&_v=ma4.0.1"

    invoke-direct {v1, v2, v3}, Lcom/google/android/gms/analytics/ab;-><init>(Ljava/lang/String;Z)V

    iput-object v1, p0, Lcom/google/android/gms/analytics/ac;->vB:Lcom/google/android/gms/analytics/ab;
    ...
    invoke-interface {v2, v0, v3, v1}, Lcom/google/android/gms/analytics/n;->a(Ljava/util/List;Lcom/google/android/gms/analytics/ab;Z)I
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/gms/analytics/ac;->b(Ljava/util/Collection;)V
...
.method cW()I
    ...
    iget-wide v2, p0, Lcom/google/android/gms/analytics/ac;->vC:J
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/gms/analytics/ac;->tg:Lcom/google/android/gms/analytics/i;
    ...
    :goto_1
    invoke-interface {v1, v2}, Lcom/google/android/gms/analytics/e;->r(Z)V
...
.method cX()I
    ...
    :goto_2
    :try_start_2
    const-string v1, "Error getting numStoredHits"
...
.method public j(J)V
    ...
    invoke-virtual {v0, v6, v2, v1}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public t(I)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lcom/google/android/gms/analytics/ac;->L(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/google/android/gms/analytics/x;-><init>(Ljava/lang/String;JJ)V
    ...
    invoke-virtual/range {p0 .. p0}, Landroid/database/sqlite/SQLiteCursor;->getWindow()Landroid/database/CursorWindow;
    ...
    check-cast p0, Lcom/google/android/gms/analytics/x;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/analytics/x;->J(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/analytics/x;->K(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/analytics/x;->cP()J
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/analytics/x;->cO()Ljava/lang/String;
