...
.method static handlePermissionResponse(Lcom/facebook/Response;)Lcom/facebook/Session$PermissionsPair;
    ...
    invoke-virtual {p0, v1}, Lcom/facebook/Response;->getGraphObjectAs(Ljava/lang/Class;)Lcom/facebook/model/GraphObject;
    ...
    invoke-interface {v1, v4}, Lcom/facebook/model/GraphObjectList;->get(I)Ljava/lang/Object;
    ...
    invoke-interface {p0, v7}, Lcom/facebook/model/GraphObject;->getProperty(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v7}, Lcom/facebook/model/GraphObject;->getProperty(Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_8
    new-instance v1, Lcom/facebook/Session$PermissionsPair;

    invoke-direct {v1, v2, v3}, Lcom/facebook/Session$PermissionsPair;-><init>(Ljava/util/List;Ljava/util/List;)V
...
.method public static openActiveSession(Landroid/content/Context;Lc/m/x/a/gv/d;ZLcom/facebook/Session$StatusCallback;)Lcom/facebook/Session;
    .locals 1

    new-instance v0, Lcom/facebook/Session$OpenRequest;

    invoke-direct {v0, p1}, Lcom/facebook/Session$OpenRequest;-><init>(Lc/m/x/a/gv/d;)V
...
.method public static openActiveSession(Landroid/content/Context;Lc/m/x/a/gv/d;ZLjava/util/List;Lcom/facebook/Session$StatusCallback;)Lcom/facebook/Session;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getDeclinedPermissions()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/facebook/AccessToken;->getDeclinedPermissions()Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
