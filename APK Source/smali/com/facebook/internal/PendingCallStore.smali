...
.method private static declared-synchronized createInstance()V
    ...
    const-class v0, Lcom/facebook/internal/PendingCallStore;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/facebook/internal/PendingCallStore;->mInstance:Lcom/facebook/internal/PendingCallStore;

    if-nez v1, :cond_0

    new-instance v1, Lcom/facebook/internal/PendingCallStore;

    invoke-direct {v1}, Lcom/facebook/internal/PendingCallStore;-><init>()V

    sput-object v1, Lcom/facebook/internal/PendingCallStore;->mInstance:Lcom/facebook/internal/PendingCallStore;
    :try_end_0
...
.method public getPendingCallById(Ljava/util/UUID;)Lcom/facebook/widget/FacebookDialog$PendingCall;
    ...
    check-cast p0, Lcom/facebook/widget/FacebookDialog$PendingCall;
