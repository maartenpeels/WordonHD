...
.method private static declared-synchronized populateTestAccounts(Ljava/util/Collection;Lcom/facebook/model/GraphObject;)V
    ...
    const-class v3, Lcom/facebook/model/GraphUser;

    invoke-interface {p1, v0, v3}, Lcom/facebook/model/GraphObject;->getPropertyAs(Ljava/lang/String;Ljava/lang/Class;)Lcom/facebook/model/GraphObject;

    move-result-object v0

    check-cast v0, Lcom/facebook/model/GraphUser;

    invoke-interface {v0}, Lcom/facebook/model/GraphUser;->getName()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p0, v0}, Lcom/facebook/TestSession$TestAccount;->setName(Ljava/lang/String;)V
