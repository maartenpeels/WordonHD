.class public Lair/com/flaregames/wordon/AppEntry;
...
.field private static final RESOURCE_CLASS:Ljava/lang/String; = "air.com.flaregames.wordon.R"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lair/com/flaregames/wordon/AppEntry;->sRuntimeClassesLoaded:Z

    .line 61
    const/4 v0, 0x0

    sput-object v0, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapper:Ljava/lang/Object;

    .line 62
    const-string v0, "com.adobe.air"

    sput-object v0, Lair/com/flaregames/wordon/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;
...
.method private BroadcastIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lair/com/flaregames/wordon/AppEntry;->startActivity(Landroid/content/Intent;)V
    :try_end_0
...
.method private varargs InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .prologue
    .line 350
    sget-boolean v1, Lair/com/flaregames/wordon/AppEntry;->sRuntimeClassesLoaded:Z
    ...
    .line 357
    :try_start_0
    sget-object v1, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapper:Ljava/lang/Object;
...
.method private InvokeWrapperOnCreate()V
    ...
    .line 328
    :try_start_0
    sget-object v7, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v4, v7}, Lair/com/flaregames/wordon/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic access$000(Lair/com/flaregames/wordon/AppEntry;)V
    .locals 0
    .param p0, "x0"    # Lair/com/flaregames/wordon/AppEntry;

    .prologue
    .line 55
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->launchMarketPlaceForAIR()V

    return-void
.end method

.method static synthetic access$100(Lair/com/flaregames/wordon/AppEntry;)V
    .locals 0
    .param p0, "x0"    # Lair/com/flaregames/wordon/AppEntry;

    .prologue
    .line 55
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->loadSharedRuntimeDex()V

    return-void
.end method

.method static synthetic access$200(Lair/com/flaregames/wordon/AppEntry;Z)V
    .locals 0
    .param p0, "x0"    # Lair/com/flaregames/wordon/AppEntry;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 55
    invoke-direct {p0, p1}, Lair/com/flaregames/wordon/AppEntry;->createActivityWrapper(Z)V
...
.method static synthetic access$300()Z
    ...
    .prologue
    .line 55
    sget-boolean v0, Lair/com/flaregames/wordon/AppEntry;->sRuntimeClassesLoaded:Z

    return v0
.end method

.method static synthetic access$400(Lair/com/flaregames/wordon/AppEntry;)V
    .locals 0
    .param p0, "x0"    # Lair/com/flaregames/wordon/AppEntry;

    .prologue
    .line 55
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->InvokeWrapperOnCreate()V
...
.method static synthetic access$500()V
    ...
    .prologue
    .line 55
    invoke-static {}, Lair/com/flaregames/wordon/AppEntry;->KillSelf()V
...
.method private createActivityWrapper(Z)V
    ...
    .line 620
    :try_start_0
    sget-object v1, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    sput-object v1, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapper:Ljava/lang/Object;
...
.method private isRuntimeInstalled()Z
    ...
    .prologue
    .line 120
    invoke-virtual {p0}, Lair/com/flaregames/wordon/AppEntry;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    :try_start_0
    sget-object v2, Lair/com/flaregames/wordon/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;
...
.method private launchAIRService()V
    ...
    .line 284
    new-instance v0, Lair/com/flaregames/wordon/AppEntry$4;

    invoke-direct {v0, p0}, Lair/com/flaregames/wordon/AppEntry$4;-><init>(Lair/com/flaregames/wordon/AppEntry;)V

    .line 315
    .local v0, "conn":Landroid/content/ServiceConnection;
    const/4 v2, 0x1

    invoke-virtual {p0, v1, v0, v2}, Lair/com/flaregames/wordon/AppEntry;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private launchMarketPlaceForAIR()V
    ...
    invoke-virtual {p0}, Lair/com/flaregames/wordon/AppEntry;->getComponentName()Landroid/content/ComponentName;
    ...
    sget-object v6, Lair/com/flaregames/wordon/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v3}, Lair/com/flaregames/wordon/AppEntry;->BroadcastIntent(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
...
.method private loadCaptiveRuntimeClasses()Z
    ...
    sput-object v1, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    sput-boolean v1, Lair/com/flaregames/wordon/AppEntry;->sRuntimeClassesLoaded:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private loadSharedRuntimeDex()V
    ...
    .line 596
    sget-object v1, Lair/com/flaregames/wordon/AppEntry;->RUNTIME_PACKAGE_ID:Ljava/lang/String;

    const/4 v2, 0x3

    invoke-virtual {p0, v1, v2}, Lair/com/flaregames/wordon/AppEntry;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lair/com/flaregames/wordon/AppEntry;->getFilesDir()Ljava/io/File;
    ...
    sput-object v1, Lair/com/flaregames/wordon/AppEntry;->sDloader:Ldalvik/system/DexClassLoader;

    .line 602
    sget-object v1, Lair/com/flaregames/wordon/AppEntry;->sDloader:Ldalvik/system/DexClassLoader;
...
.method private registerForNotifications()V
    ...
    .line 271
    invoke-virtual {p0, v0}, Lair/com/flaregames/wordon/AppEntry;->startService(Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method private showDialog(ILjava/lang/String;II)V
    ...
    .line 159
    new-instance v1, Lair/com/flaregames/wordon/AppEntry$1;

    invoke-direct {v1, p0}, Lair/com/flaregames/wordon/AppEntry$1;-><init>(Lair/com/flaregames/wordon/AppEntry;)V
    ...
    .line 166
    new-instance v1, Lair/com/flaregames/wordon/AppEntry$2;

    invoke-direct {v1, p0}, Lair/com/flaregames/wordon/AppEntry$2;-><init>(Lair/com/flaregames/wordon/AppEntry;)V
    ...
    .line 172
    new-instance v1, Lair/com/flaregames/wordon/AppEntry$3;

    invoke-direct {v1, p0}, Lair/com/flaregames/wordon/AppEntry$3;-><init>(Lair/com/flaregames/wordon/AppEntry;)V
...
.method private showRuntimeNotInstalledDialog()V
    ...
    const-string v2, "air.com.flaregames.wordon.R"
    ...
    invoke-virtual {p0, v3}, Lair/com/flaregames/wordon/AppEntry;->getString(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v1, v3, v4}, Lair/com/flaregames/wordon/AppEntry;->showDialog(ILjava/lang/String;II)V
...
.method public dispatchGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    .local v0, "handled":Z
    :try_start_0
    sget-object v2, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v1, v2}, Lair/com/flaregames/wordon/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public finishActivityFromChild(Landroid/app/Activity;I)V
    ...
    invoke-direct {p0, v0, v1}, Lair/com/flaregames/wordon/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    .local v2, "retval":Z
    :try_start_0
    sget-object v3, Lair/com/flaregames/wordon/AppEntry;->sAndroidActivityWrapperClass:Ljava/lang/Class;
    ...
    invoke-direct {p0, v1, v3}, Lair/com/flaregames/wordon/AppEntry;->InvokeMethod(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    .end local p0    # "this":Lair/com/flaregames/wordon/AppEntry;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 222
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->loadCaptiveRuntimeClasses()Z
    ...
    .line 225
    sget-boolean v4, Lair/com/flaregames/wordon/AppEntry;->sRuntimeClassesLoaded:Z

    if-nez v4, :cond_1

    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->isRuntimeInstalled()Z
    ...
    .line 230
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->isRuntimeOnExternalStorage()Z
    ...
    .line 231
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->showRuntimeOnExternalStorageDialog()V
    ...
    .line 233
    :cond_0
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->showRuntimeNotInstalledDialog()V
    ...
    .line 241
    invoke-direct {p0, v0}, Lair/com/flaregames/wordon/AppEntry;->createActivityWrapper(Z)V
    ...
    .line 264
    :goto_1
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->registerForNotifications()V
    ...
    .line 260
    :cond_4
    invoke-direct {p0}, Lair/com/flaregames/wordon/AppEntry;->launchAIRService()V
