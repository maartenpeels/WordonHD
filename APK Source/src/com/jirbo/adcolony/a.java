...
//            AdColonyAd, ADCVideo, j, ae, 
//            u, b, AdColonyV4VCReward, AdColonyV4VCListener

class com.jirbo.adcolony.a
{
...
_L4:
    ...
    static class b extends Handler
    {
        ...
        public void handleMessage(Message message)
        {
            ...
            message = new AdColonyV4VCReward(flag, message, i1);
            for (int j1 = 0; j1 < com.jirbo.adcolony.a.ae.size(); j1++)
            {
                ((AdColonyV4VCListener)com.jirbo.adcolony.a.ae.get(j1)).onAdColonyV4VCReward(message);
            }
