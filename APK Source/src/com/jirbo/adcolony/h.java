...
class h extends View
{
    ...
    void a(String s1, String s2)
    {
        ...
        if (i1 > a.f - a("WW") - a(s2))
        {
            ...
            int k1 = 0;
            String s3 = "";
            for (; j1 < a.f - a("WW") - a(s2); j1 = a(s3))
            {
                s3 = (new StringBuilder()).append(s3).append(s1.charAt(k1)).toString();
                k1++;
            }
    ...
    public boolean a()
    {
        ...
        if (j1 > i1)
        {
            d2 = (double)(j1 - i1) / 360D;
        } else
        {
            d2 = (double)(i1 - j1) / 360D;
        }
        if (d2 < 0.80000000000000004D && !a.m)
        {
            n = true;
        }
        d1 = d2;
        ...
        g.a(d2 / 1.8D);
        h.a(d2 / 1.8D);
        t.setTextSize((float)(18D * d2));
        if (n)
        {
            t.setTextSize((float)(d2 * 9D));
        }
