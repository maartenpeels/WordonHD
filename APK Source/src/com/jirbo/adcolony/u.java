    ...
    implements ADCDownload.Listener
{
    ...
    void a(String s, ADCData.g g, AdColonyAd adcolonyad)
    {
        ...
        g.b("s_imp_count", com.jirbo.adcolony.a.l.e.i);
        a(s, adcolonyad.i.t.D.e(s), g, adcolonyad);
    ...
    void a(String s, AdColonyAd adcolonyad)
    {
        if (a != null && a.b != null && a.b.j != null && a.b.j.n != null && a.b.j.n.a(s) != null)
        {
            ...
            if (s != null && ((n.ab) (s)).h != null && ((n.ab) (s)).h.a != null)
            {
                ...
                g.b("request_denied_reason", com.jirbo.adcolony.a.ac);
    ...
    void a(String s, String s1, ADCData.g g, AdColonyAd adcolonyad)
    {
        ...
        if (adcolonyad != null)
        {
            g.b("asi", adcolonyad.l);
        }
        g.b("sid", a.e.j);
        g.b("guid", s2);
        g.b("guid_key", ab.b((new StringBuilder()).append(s2).append("DUBu6wJ27y6xs7VWmNDw67DD").toString()));
        adcolonyad = new a();
        adcolonyad.a = s;
        adcolonyad.b = s1;
        l.a.b("EVENT ---------------------------");
        ...
        {
            adcolonyad.d = g.e("v4vc_name");
            adcolonyad.h = g.g("v4vc_amount");
        }
        b.add(adcolonyad);
        e = true;
    ...
    public void on_download_finished(ADCDownload adcdownload)
    {
        ...
        if (flag1)
        {
            ...
            if (a1.c != null)
            {
                ...
                if (obj != null)
                {
                    flag = ((ADCData.g) (obj)).e("status").equals("success");
                    if (flag && a1.a.equals("reward_v4vc"))
                    {
...
_L2:
        ...
        } else
        {
            ...
            l.a.a("Retrying in ").a(j).a(" seconds (attempt ").a(a1.f).b(")");
            a1.g = j;
            a1.e = ab.c() + (double)j;
        }
