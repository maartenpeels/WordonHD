...
public class AdColony
{
    ...
    {
        if (com.jirbo.adcolony.a.af.contains(adcolonyadavailabilitylistener))
        {
            return;
        } else
        {
            com.jirbo.adcolony.a.af.add(adcolonyadavailabilitylistener);
            return;
        }
    }
    ...
    {
        if (com.jirbo.adcolony.a.ae.contains(adcolonyv4vclistener))
        {
            return;
        } else
        {
            com.jirbo.adcolony.a.ae.add(adcolonyv4vclistener);
            return;
        }
    }
...
_L5:
    ...
    public static boolean isZoneNative(String s)
    {
        ...
        if (com.jirbo.adcolony.a.l.b == null)
        {
            return false;
        }
        if (com.jirbo.adcolony.a.l.b.j == null)
        {
            return false;
        }
        if (com.jirbo.adcolony.a.l.b.j.n == null)
        {
            return false;
        }
        if (com.jirbo.adcolony.a.l.b.j.n.a(s) == null)
        {
            return false;
        }
        if (com.jirbo.adcolony.a.l.b.j.n.a(s).i == null)
        {
            return false;
        }
        if (com.jirbo.adcolony.a.l.b.j.n.a(s).i.a == null)
        {
            return false;
        }
        for (int i = 0; i < com.jirbo.adcolony.a.l.b.j.n.a(s).i.a.size(); i++)
        {
    ...
    public static void resume(Activity activity1)
    {
        ...
        {
            (new Thread(new Runnable(activity1) {
