...
class c
{
    ...
    void a()
    {
        ...
        D = "";
        H = a((new StringBuilder()).append("").append(com.jirbo.adcolony.g.c()).toString(), "");
        I = a((new StringBuilder()).append("").append(com.jirbo.adcolony.g.d()).toString(), "");
        if (ab.d() && ab.e())
        {
            flag = true;
        } else
        ...
        ((z) (obj)).a(com.jirbo.adcolony.q.a((new StringBuilder()).append("").append(com.jirbo.adcolony.g.f()).toString()));
        ((z) (obj)).a("&screen_height=");
        ((z) (obj)).a(com.jirbo.adcolony.q.a((new StringBuilder()).append("").append(com.jirbo.adcolony.g.g()).toString()));
        ((z) (obj)).a("&sdk_type=");
    ...
    void b()
    {
        ...
        {
            a.O = false;
            i.b("end_card_filepath", o1.b(((n.v) (obj)).d));
            i.b("info_image_normal", o1.b(((n.v) (obj)).f.f));
            i.b("info_image_down", o1.b(((n.v) (obj)).f.h));
            i.b("info_url", ((n.v) (obj)).f.j);
            i.b("replay_image_normal", o1.b(((n.v) (obj)).h.f));
            i.b("replay_image_down", o1.b(((n.v) (obj)).h.h));
            i.b("continue_image_normal", o1.b(((n.v) (obj)).i.f));
            i.b("continue_image_down", o1.b(((n.v) (obj)).i.h));
            i.b("download_image_normal", o1.b(((n.v) (obj)).g.f));
            i.b("download_image_down", o1.b(((n.v) (obj)).g.h));
            i.b("download_url", ((n.v) (obj)).g.j);
        }
        obj = m.v;
        i.b("end_card_enabled", m.u.d);
