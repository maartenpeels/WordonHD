...
class s
{
    ...
    void b(char c1)
    {
        if (!a(c1))
        {
            throw new AdColonyException((new StringBuilder()).append("'").append(c1).append("' expected.").toString());
        } else
        {
            return;
        }
    ...
    void b(String s1)
    {
        if (!a(s1))
        {
            throw new AdColonyException((new StringBuilder()).append("\"").append(s1).append("\" expected.").toString());
        } else
        {
            return;
        }
