    ...
    implements android.media.MediaPlayer.OnCompletionListener, android.media.MediaPlayer.OnErrorListener, android.media.MediaPlayer.OnPreparedListener
{
        ...
        implements android.view.TextureView.SurfaceTextureListener
    {
        ...
        public boolean onTouchEvent(MotionEvent motionevent)
        {
            ...
            if (i1 == 1 && com.jirbo.adcolony.a.v && com.jirbo.adcolony.q.c())
            {
                if (f1 > (float)((c.aq - c.O.f) + 8) && f2 < (float)(c.O.g + 8) && !c.u && c.ad != null && c.ad.isPlaying())
                {
                    return true;
                }
                ...
                if ((c.z || c.u) && com.jirbo.adcolony.q.c())
                {
                    ...
                    if (c.u)
                    {
                        ...
                        com.jirbo.adcolony.a.l.a("start", (new StringBuilder()).append("{\"ad_slot\":").append(c.K.h.k.d).append(", \"replay\":").append(c.K.s).append("}").toString(), c.K);
    ...
    class b extends View
    {
        ...
        public void onDraw(Canvas canvas)
        {
            ...
            if (getLocalVisibleRect(rect) && android.os.Build.VERSION.SDK_INT >= 14 && b.z)
            {
                ...
                {
                    if (!a && !b.u && b.ad != null && !b.ad.isPlaying() && !b.A && !b.K.a(true))
                    {
                        if (!b.t);
                    }
                    if (!b.t)
...
_L3:
        if (T == P.a && (double)f1 > 0.0D && !x)
        {
            ...
            T = O.a;
            com.jirbo.adcolony.a.l.d.a("sound_unmute", g1, K);
            r = true;
            return;
        }
...
_L4:
        ...
        T = P.a;
        com.jirbo.adcolony.a.l.d.a("sound_mute", g2, K);
        r = false;
        return;
...
_L5:
    ...
    void a(Activity activity, String s1, int i1, int j1)
    {
        ...
        {
            j1 = activity.getWidth();
            i1 = activity.getHeight();
        }
        k1 = i1;
        if (j1 < i1)
        {
        ...
        K.j = "native";
        K.k = "native";
        com.jirbo.adcolony.a.l.d.a(s1, K);
...
_L6:
        ...
        if (W)
        {
            ...
            Z.setTextColor(au);
            Z.setOnTouchListener(new android.view.View.OnTouchListener() {
...
_L3:
        if (!u && ad != null && ad.isPlaying())
        {
            ...
            } else
            {
                ...
                {
                    H = true;
                    com.jirbo.adcolony.a.l.a("native_start", (new StringBuilder()).append("{\"ad_slot\":").append(K.h.k.d).append(", \"replay\":false}").toString(), K);
                }
            }
        } else
        if (!R.a)
    ...
    public boolean onTouchEvent(MotionEvent motionevent)
    {
        ...
        if (motionevent.getAction() == 1 && com.jirbo.adcolony.a.v && com.jirbo.adcolony.q.c())
        {
            ...
            if (u)
            {
                ...
                motionevent = K.h.k;
                motionevent.d = ((ag) (motionevent)).d + 1;
                com.jirbo.adcolony.a.l.a("start", (new StringBuilder()).append("{\"ad_slot\":").append(K.h.k.d).append(", \"replay\":").append(K.s).append("}").toString(), K);
