    ...
    public void onDraw(Canvas canvas)
    {
        ...
        if (k == G.getViewsPerReward() || k == 0)
        {
            ...
            if (s)
            {
                ...
                a((new StringBuilder()).append("video. You earned ").append(q).append(".").toString(), z, (int)((double)A - (double)j * 1.5D), canvas);
            } else
            {
                a("Thanks for watching the sponsored", z, (int)((double)A - (double)j * 2.7999999999999998D), canvas);
                a((new StringBuilder()).append("video. You earned ").append(q).toString(), z, (int)((double)A - (double)j * 2.0499999999999998D), canvas);
        ...
        } else
        {
            ...
            if (s)
            {
                a((new StringBuilder()).append("Thank you. Watch ").append(k).append(" more ").append(s).toString(), z, (int)((double)A - (double)j * 2.5D), canvas);
                a((new StringBuilder()).append("to earn ").append(q).append(".").toString(), z, (int)((double)A - (double)j * 1.5D), canvas);
            } else
            {
                a((new StringBuilder()).append("Thank you. Watch ").append(k).append(" more ").append(s).toString(), z, (int)((double)A - (double)j * 2.7999999999999998D), canvas);
                a((new StringBuilder()).append("to earn ").append(q).toString(), z, (int)((double)A - (double)j * 2.0499999999999998D), canvas);
                a((new StringBuilder()).append(r).append(".").toString(), z, (int)((double)A - (double)j * 1.3D), canvas);
            }
        }
