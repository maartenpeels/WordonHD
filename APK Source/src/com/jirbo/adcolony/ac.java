    ...
    public void onDraw(Canvas canvas)
    {
        ...
        } else
        {
            ...
            if (!s)
            {
                ...
                a((new StringBuilder()).append("").append(k).append(" more ").append(s).append(" to earn ").append(q).toString(), z, (int)((double)A - (double)j * this.j), canvas);
                a((new StringBuilder()).append(r).append(")?").toString(), z, (int)((double)A - (double)j * this.k), canvas);
            } else
            {
                a("Watch a sponsored video now (Only", z, (int)((double)A - (double)j * l), canvas);
                a((new StringBuilder()).append("").append(k).append(" more ").append(s).append(" to earn ").append(q).append(")?").toString(), z, (int)((double)A - (double)j * m), canvas);
            }
        }
