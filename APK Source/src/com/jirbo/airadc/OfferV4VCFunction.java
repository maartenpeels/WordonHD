...
label0:
        {
            ...
            {
                (new AdColonyV4VCAd(afreobject)).withConfirmationDialog().withResultsDialog(flag).withListener(((AirADCContext) (frecontext)).listener).show();
                break label0;
            }
            try
            {
                (new AdColonyV4VCAd()).withConfirmationDialog().withResultsDialog(flag).withListener(((AirADCContext) (frecontext)).listener).show();
            }
