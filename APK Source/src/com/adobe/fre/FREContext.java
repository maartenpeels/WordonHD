...
public abstract class FREContext
{
    ...
    {
        Object obj = getFunctions();
        registerFunctionCount(l, ((Map) (obj)).size());
        java.util.Map.Entry entry;
        for (obj = ((Map) (obj)).entrySet().iterator(); ((Iterator) (obj)).hasNext(); registerFunction(l, (String)entry.getKey(), (FREFunction)entry.getValue()))
        {
