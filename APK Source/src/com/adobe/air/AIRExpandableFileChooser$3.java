    ...
    implements android.view.
{
    ...
    {
        view = AIRExpandableFileChooser.access$700(AIRExpandableFileChooser.this).getText().toString();
        if (view.length() != 0)
        {
            AIRExpandableFileChooser.access$800(AIRExpandableFileChooser.this).clear();
            AIRExpandableFileChooser.access$800(AIRExpandableFileChooser.this).add(view);
