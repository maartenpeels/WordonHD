...
public class mLastFocusDirection extends EditText
{
    ...
    protected void onDraw(Canvas canvas)
    {
        if (AndroidStageText.access$300(AndroidStageText.this) != null)
        {
            ...
            canvas.clipRect(new Rect(AndroidStageText.access$300(AndroidStageText.this).left + i, AndroidStageText.access$300(AndroidStageText.this).top + j, i + AndroidStageText.access$300(AndroidStageText.this).right, j + AndroidStageText.access$300(AndroidStageText.this).bottom));
            super.onDraw(canvas);
            canvas.restore();
            return;
        } else
...
_L3:
    ...
    protected void onTextChanged(CharSequence charsequence, int i, int j, int k)
    {
        ...
        if (AndroidStageText.access$100(charsequence) == 0L)
        {
            return;
        } else
        {
            AndroidStageText.access$800(charsequence, AndroidStageText.access$100(charsequence));
            return;
        }
    }
