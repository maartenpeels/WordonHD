...
public class Entrypoints
{
    ...
    public boolean EntryDownloadConfig(Object obj, String s)
    {
        ...
        Object obj1 = s_context.getApplicationInfo();
        s_packageName = ((ApplicationInfo) (obj1)).packageName;
        ApplicationFileManager.setAndroidPackageName(s_packageName);
        ApplicationFileManager.setAndroidAPKPath(((ApplicationInfo) (obj1)).sourceDir);
        obj1 = s_context.getCacheDir();
        if (obj1 == null)
        {
            return false;
        } else
        {
            ApplicationFileManager.processAndroidDataPath(((File) (obj1)).getAbsolutePath());
