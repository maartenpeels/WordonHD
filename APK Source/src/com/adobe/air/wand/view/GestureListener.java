    ...
    implements android.view.GestureDetector.OnGestureListener, android.view.GestureDetector.OnDoubleTapListener, android.view.ScaleGestureDetector.OnScaleGestureListener
{
    ...
    public GestureListener(Context context, CompanionView companionview)
    {
        ...
        float f = ((DisplayMetrics) (context)).xdpi;
        screenPPI = (int)((((DisplayMetrics) (context)).ydpi + f) / 2.0F);
    }
    ...
    public boolean onScale(ScaleGestureDetector scalegesturedetector)
    {
        ...
        if (d2 != 0.0D)
        {
            if (mInZoomTransformGesture || (25.399999618530273D * d3) / (double)screenPPI > 8D)
            {
                ...
                mCompanionView.onGestureListener(byte0, 0, true, f2, f3, f, f1, 0.0F, 0.0F, 0.0F);
                return true;
            } else
            {
                return false;
...
label0:
        {
            ...
            mCompanionView.onGestureListener(byte0, 2, true, f4, f5, 1.0F, 1.0F, f2, 0.0F, 0.0F);
        }
...
_L6:
        ...
        mPreviousPanLocX = f4;
        mPreviousPanLocY = f5;
        mCompanionView.onGestureListener(byte0, 1, true, f4, f5, 1.0F, 1.0F, 0.0F, -1F * f, -1F * f1);
_L4:
        return true;
_L7:
        if (mInPanTransformGesture)
        ...
        if (motionevent1.getPointerCount() == 1)
        {
            ...
            if (k >= 0 && k < 2 && mCheckForSwipe && motionevent.getPointerCount() == 1)
            {
                ...
                if (flag)
                {
                    ...
                    f3 = motionevent1.getY(0);
                    mCompanionView.onGestureListener(8, 4, true, f2, f3, 1.0F, 1.0F, 0.0F, f, f1);
