...
public class WandManager
{
        ...
        implements com.adobe.air.wand.view.WandView.Listener
    {
            ...
            throws Exception
        {
            ...
            {
                mWandConnection.onReadyForConnection();
                return;
            } else
            {
                mListenToConfigChange = true;
                return;
            }
        }
    ...
    private boolean mListenToConfigChange;
    ...
    public void onConfigurationChanged(Configuration configuration)
        throws Exception
    {
        if (mListenToConfigChange && configuration.orientation == 2)
        {
            mListenToConfigChange = false;
            mWandConnection.onReadyForConnection();
        }
...
/*
    static boolean access$402(WandManager wandmanager, boolean flag)
    {
        wandmanager.mListenToConfigChange = flag;
        return flag;
    }
