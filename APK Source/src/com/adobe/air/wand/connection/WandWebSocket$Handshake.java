...
private static class mDestinationID
{
        ...
        throws Exception
    {
        ...
        mdestinationid.mProtocol = s.getString("protocol");
        mdestinationid.mVersion = s.getString("version");
        mdestinationid.mSourceID = s.getString("sourceID");
        mdestinationid.mDestinationID = s.getString("destinationID");
