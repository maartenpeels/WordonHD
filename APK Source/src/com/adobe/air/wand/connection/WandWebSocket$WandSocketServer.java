        ...
        try
        {
            WandWebSocket.access$600(WandWebSocket.this).schedule(new TimerTask() {
                ...
                public void run()
                {
                    ...
                    "OPEN_SYNCHRONIZER";
                    JVM INSTR monitorexit ;
                    WandWebSocket.access$100(this$0).close(1003, "AIR Gamepad handshake timedout");
                    return;
                    exception1;
                    "HANDSHAKE_SYNCHRONIZER";
                    JVM INSTR monitorexit ;
...
_L2:
    ...
    public void onMessage(WebSocket websocket, String s)
    {
        ...
        JVM INSTR monitorexit ;
        return;
        this._cls0 _lcls0 = com.adobe.air.wand.connection.this._mth0(s);
        s = _lcls0;
...
_L1:
        WandWebSocket.access$502(WandWebSocket.this, s);
        if (WandWebSocket.access$700(WandWebSocket.this) != null)
        {
            WandWebSocket.access$700(WandWebSocket.this).nOpen(s.ion());
        }
_L3:
        "HANDSHAKE_SYNCHRONIZER";
        JVM INSTR monitorexit ;
