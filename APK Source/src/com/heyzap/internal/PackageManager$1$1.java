...
//            Logger, Base64, PackageManager, APIClient, 
//            Utils

class  extends JsonHttpResponseHandler
{

    final r.commit this$0;
    ...
    public void onSuccess(int i, Header aheader[], JSONObject jsonobject)
    {
        HashSet hashset;
        i = 0;
        if (val$debug && val$activity != null)
        {
...
_L7:
        ...
        APIClient.post(context, (new StringBuilder()).append(PackageManager.access$000()).append("aip").toString(), requestparams, new JsonHttpResponseHandler() {

            final PackageManager._cls1._cls1 this$1;
            final int val$installedCount;
            final int val$totalCount;

            public void onSuccess(int k, Header aheader1[], JSONObject jsonobject1)
            {
