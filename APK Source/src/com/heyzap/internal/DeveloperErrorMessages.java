...
public class DeveloperErrorMessages
{
    ...
    public static final String ALL_DISABLED = "Heyzap is disabled and has not started.";
    ...
    public static final String PERIMSSIONS_NOT_PRESENT = "Heyzap not started! You must add the following permissions to your AndroidManifest.xml <uses-permission android:name=\"android.permission.INTERNET\" /><uses-permission android:name=\"android.permission.ACCESS_NETWORK_STATE\" />";
    ...
    public static final String UNSUPPORTED_ANDROID_SDK_VERSION;

    public DeveloperErrorMessages()
    {
    }

    static 
    {
        UNSUPPORTED_ANDROID_SDK_VERSION = String.format("SDK version %i is not supported, disabling Heyzap Ads.", new Object[] {
