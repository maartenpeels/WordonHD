...
_L7:
            ...
            APIClient.post(context, (new StringBuilder()).append(PackageManager.access$000()).append("aip").toString(), requestparams, new PackageManager._cls1._cls1._cls2());
_L2:
            aheader = prefs.edit();
...
_L8:
        ...
        // Unreferenced inner class com/heyzap/internal/PackageManager$1$1$2

/* anonymous class */
        class PackageManager._cls1._cls1._cls2 extends JsonHttpResponseHandler
        {
            ...
            public void onSuccess(int i, Header aheader[], JSONObject jsonobject)
            {
                if (debug && activity != null)
                {
                    activity.runOnUiThread(new PackageManager._cls1._cls1._cls2._cls1());
                }
            }
        ...
        // Unreferenced inner class com/heyzap/internal/PackageManager$1$1$2$1

/* anonymous class */
        class PackageManager._cls1._cls1._cls2._cls1
            implements Runnable
        {
