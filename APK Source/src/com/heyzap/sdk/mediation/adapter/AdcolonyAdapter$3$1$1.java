...
class per extends com.heyzap.internal.Task
{
    ...
    public void run()
    {
        if (val$wrapper.videoAd != null && val$wrapper.videoAd.isReady() || val$wrapper.incentivizedAd != null && val$wrapper.incentivizedAd.isReady())
        {
            val$wrapper.fetchFuture.set(new com.heyzap.mediation.abstr.sult());
        }
        if (!val$wrapper.fetchFuture.isDone())
        {
            retry();
        }
    }
...
/* anonymous class */
    class AdcolonyAdapter._cls3._cls1 extends com.heyzap.internal.RetryManager.RetryableTask
    {
        ...
        //                       2 188;
               goto _L1 _L2 _L3
_L1:
            (new RetryManager(wrapper. new AdcolonyAdapter._cls3._cls1._cls1(), new com.heyzap.internal.RetryManager.ExponentialSchedule(1.5D, 4L, TimeUnit.SECONDS), AdcolonyAdapter.access$1800(this$0))).start();
            wrapper.fetchFuture.addListener(new AdcolonyAdapter._cls3._cls1._cls2(), AdcolonyAdapter.access$1900(this$0));
            return;
_L2:
...
_L4:
        ...
        // Unreferenced inner class com/heyzap/sdk/mediation/adapter/AdcolonyAdapter$3$1$2

/* anonymous class */
        class AdcolonyAdapter._cls3._cls1._cls2
            implements Runnable
        {
