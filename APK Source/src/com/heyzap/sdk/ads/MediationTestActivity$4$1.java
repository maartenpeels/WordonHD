...
class t> extends AsyncHttpResponseHandler
{
    ...
    final Status.setRemoteStatus this$1;
...
_L2:
    ...
    // Unreferenced inner class com/heyzap/sdk/ads/MediationTestActivity$4

/* anonymous class */
    class MediationTestActivity._cls4
        implements com.heyzap.mediation.config.ConfigLoader.MediationConfigListener
    {
        ...
        {
            APIClient.get(MediationTestActivity.this, "https://med.heyzap.com/info", new RequestParams(), new MediationTestActivity._cls4._cls1());
        }
