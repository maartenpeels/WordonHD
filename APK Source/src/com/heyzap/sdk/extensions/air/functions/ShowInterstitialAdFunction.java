...
public class ShowInterstitialAdFunction
    implements FREFunction
{

    private static String TAG = "ShowInterstitialAdFunction";

    public ShowInterstitialAdFunction()
    {
    }
    ...
    public FREObject call(FREContext frecontext, FREObject afreobject[])
    {
        ...
        InterstitialAd.display(frecontext.getActivity());
        break MISSING_BLOCK_LABEL_103;
        try
        {
            afreobject = afreobject[0].getAsString();
            InterstitialAd.display(frecontext.getActivity(), afreobject);
        }
