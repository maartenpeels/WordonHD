...
public class VideoAdAvailableFunction
    implements FREFunction
{

    private static String TAG = "VideoAdAvailableFunction";

    public VideoAdAvailableFunction()
    {
    }
...
_L2:
        frecontext = VideoAd.isAvailable();
_L5:
        return FREObject.newObject(frecontext.booleanValue());
_L3:
        frecontext = VideoAd.isAvailable(afreobject[0].getAsString());
