...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 2: // '\002'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            parcel = h(com.google.android.gms.dynamic.K(parcel.readStrongBinder()));
            parcel1.writeNoException();
            if (parcel != null)
            {
        ...
        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            d d = com.google.android.gms.dynamic.K(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 7: // '\007'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            d d1 = com.google.android.gms.dynamic.K(parcel.readStrongBinder());
            if (parcel.readInt() != 0)
            {
        ...
        case 8: // '\b'
            parcel.enforceInterface("com.google.android.gms.maps.internal.ICreator");
            parcel = i(com.google.android.gms.dynamic.K(parcel.readStrongBinder()));
            parcel1.writeNoException();
            break;
        }
        if (parcel != null)
