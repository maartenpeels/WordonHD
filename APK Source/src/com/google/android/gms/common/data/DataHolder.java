...
_L4:
        ...
        Object obj1;
        long l1;
        for (int k = 0; k >= Builder.a(builder1).length || !flag; k++)
        {
        ...
        flag = cursorwindow.putNull(j, k);
        break MISSING_BLOCK_LABEL_664;
        if (obj1 instanceof String)
        {
            flag = cursorwindow.putString((String)obj1, j, k);
            break MISSING_BLOCK_LABEL_664;
        }
        if (obj1 instanceof Long)
        {
            flag = cursorwindow.putLong(((Long)obj1).longValue(), j, k);
            break MISSING_BLOCK_LABEL_664;
        }
        if (obj1 instanceof Integer)
        {
            flag = cursorwindow.putLong(((Integer)obj1).intValue(), j, k);
            break MISSING_BLOCK_LABEL_664;
        }
        ...
        flag = cursorwindow.putLong(l1, j, k);
        break MISSING_BLOCK_LABEL_664;
        if (obj1 instanceof byte[])
        {
            flag = cursorwindow.putBlob((byte[])(byte[])obj1, j, k);
            break MISSING_BLOCK_LABEL_664;
        }
        if (obj1 instanceof Double)
        {
            flag = cursorwindow.putDouble(((Double)obj1).doubleValue(), j, k);
            break MISSING_BLOCK_LABEL_664;
        }
        try
        {
