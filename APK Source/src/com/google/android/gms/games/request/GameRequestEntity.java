    ...
    implements SafeParcelable, GameRequest
{
    ...
    static boolean a(GameRequest gamerequest, Object obj)
    {
        ...
        obj = (GameRequest)obj;
        return fo.equal(((GameRequest) (obj)).getGame(), gamerequest.getGame()) && fo.equal(((GameRequest) (obj)).getRecipients(), gamerequest.getRecipients()) && fo.equal(((GameRequest) (obj)).getRequestId(), gamerequest.getRequestId()) && fo.equal(((GameRequest) (obj)).getSender(), gamerequest.getSender()) && Arrays.equals(b(((GameRequest) (obj))), b(gamerequest)) && fo.equal(Integer.valueOf(((GameRequest) (obj)).getType()), Integer.valueOf(gamerequest.getType())) && fo.equal(Long.valueOf(((GameRequest) (obj)).getCreationTimestamp()), Long.valueOf(gamerequest.getCreationTimestamp())) && fo.equal(Long.valueOf(((GameRequest) (obj)).getExpirationTimestamp()), Long.valueOf(gamerequest.getExpirationTimestamp()));
    }
