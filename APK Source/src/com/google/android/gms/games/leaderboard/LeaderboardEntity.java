    ...
    implements Leaderboard
{
    ...
    static boolean a(Leaderboard leaderboard, Object obj)
    {
        ...
        obj = (Leaderboard)obj;
        return fo.equal(((Leaderboard) (obj)).getLeaderboardId(), leaderboard.getLeaderboardId()) && fo.equal(((Leaderboard) (obj)).getDisplayName(), leaderboard.getDisplayName()) && fo.equal(((Leaderboard) (obj)).getIconImageUri(), leaderboard.getIconImageUri()) && fo.equal(Integer.valueOf(((Leaderboard) (obj)).getScoreOrder()), Integer.valueOf(leaderboard.getScoreOrder())) && fo.equal(((Leaderboard) (obj)).getVariants(), leaderboard.getVariants());
    }
