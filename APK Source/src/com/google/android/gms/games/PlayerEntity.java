    ...
    implements Player
{
    ...
    static boolean a(Player player, Object obj)
    {
        ...
        obj = (Player)obj;
        return fo.equal(((Player) (obj)).getPlayerId(), player.getPlayerId()) && fo.equal(((Player) (obj)).getDisplayName(), player.getDisplayName()) && fo.equal(((Player) (obj)).getIconImageUri(), player.getIconImageUri()) && fo.equal(((Player) (obj)).getHiResImageUri(), player.getHiResImageUri()) && fo.equal(Long.valueOf(((Player) (obj)).getRetrievedTimestamp()), Long.valueOf(player.getRetrievedTimestamp()));
    }
