    ...
    implements ExtendedGame
{
    ...
    static boolean a(ExtendedGame extendedgame, Object obj)
    {
        ...
        return fo.equal(((ExtendedGame) (obj)).getGame(), extendedgame.getGame()) && fo.equal(Integer.valueOf(((ExtendedGame) (obj)).gX()), Integer.valueOf(extendedgame.gX())) && fo.equal(Boolean.valueOf(((ExtendedGame) (obj)).gY()), Boolean.valueOf(extendedgame.gY())) && fo.equal(Integer.valueOf(((ExtendedGame) (obj)).gZ()), Integer.valueOf(extendedgame.gZ())) && fo.equal(Long.valueOf(((ExtendedGame) (obj)).ha()), Long.valueOf(extendedgame.ha())) && fo.equal(Long.valueOf(((ExtendedGame) (obj)).hb()), Long.valueOf(extendedgame.hb())) && fo.equal(((ExtendedGame) (obj)).hc(), extendedgame.hc()) && fo.equal(Long.valueOf(((ExtendedGame) (obj)).hd()), Long.valueOf(extendedgame.hd())) && fo.equal(((ExtendedGame) (obj)).he(), extendedgame.he());
    }
