    ...
    implements Room
{
    ...
    static boolean a(Room room, Object obj)
    {
        ...
        obj = (Room)obj;
        return fo.equal(((Room) (obj)).getRoomId(), room.getRoomId()) && fo.equal(((Room) (obj)).getCreatorId(), room.getCreatorId()) && fo.equal(Long.valueOf(((Room) (obj)).getCreationTimestamp()), Long.valueOf(room.getCreationTimestamp())) && fo.equal(Integer.valueOf(((Room) (obj)).getStatus()), Integer.valueOf(room.getStatus())) && fo.equal(((Room) (obj)).getDescription(), room.getDescription()) && fo.equal(Integer.valueOf(((Room) (obj)).getVariant()), Integer.valueOf(room.getVariant())) && fo.equal(((Room) (obj)).getAutoMatchCriteria(), room.getAutoMatchCriteria()) && fo.equal(((Room) (obj)).getParticipants(), room.getParticipants()) && fo.equal(Integer.valueOf(((Room) (obj)).getAutoMatchWaitEstimateSeconds()), Integer.valueOf(room.getAutoMatchWaitEstimateSeconds()));
    }
