    ...
    implements Participant
{
    ...
    static boolean a(Participant participant, Object obj)
    {
        ...
        obj = (Participant)obj;
        return fo.equal(((Participant) (obj)).getPlayer(), participant.getPlayer()) && fo.equal(Integer.valueOf(((Participant) (obj)).getStatus()), Integer.valueOf(participant.getStatus())) && fo.equal(((Participant) (obj)).gi(), participant.gi()) && fo.equal(Boolean.valueOf(((Participant) (obj)).isConnectedToRoom()), Boolean.valueOf(participant.isConnectedToRoom())) && fo.equal(((Participant) (obj)).getDisplayName(), participant.getDisplayName()) && fo.equal(((Participant) (obj)).getIconImageUri(), participant.getIconImageUri()) && fo.equal(((Participant) (obj)).getHiResImageUri(), participant.getHiResImageUri()) && fo.equal(Integer.valueOf(((Participant) (obj)).getCapabilities()), Integer.valueOf(participant.getCapabilities())) && fo.equal(((Participant) (obj)).getResult(), participant.getResult()) && fo.equal(((Participant) (obj)).getParticipantId(), participant.getParticipantId());
    }
