    ...
    implements Invitation
{
    ...
    static boolean a(Invitation invitation, Object obj)
    {
        ...
        obj = (Invitation)obj;
        return fo.equal(((Invitation) (obj)).getGame(), invitation.getGame()) && fo.equal(((Invitation) (obj)).getInvitationId(), invitation.getInvitationId()) && fo.equal(Long.valueOf(((Invitation) (obj)).getCreationTimestamp()), Long.valueOf(invitation.getCreationTimestamp())) && fo.equal(Integer.valueOf(((Invitation) (obj)).getInvitationType()), Integer.valueOf(invitation.getInvitationType())) && fo.equal(((Invitation) (obj)).getInviter(), invitation.getInviter()) && fo.equal(((Invitation) (obj)).getParticipants(), invitation.getParticipants()) && fo.equal(Integer.valueOf(((Invitation) (obj)).getVariant()), Integer.valueOf(invitation.getVariant())) && fo.equal(Integer.valueOf(((Invitation) (obj)).getAvailableAutoMatchSlots()), Integer.valueOf(invitation.getAvailableAutoMatchSlots()));
    }
