...
class ac extends aj
{
    ...
    public com.google.android.gms.internal.d.a x(Map map)
    {
        ...
        String s1;
        int i;
        obj = (com.google.android.gms.internal.d.a)map.get(XQ);
        if (obj == null || obj == dh.lT())
        {
            return dh.lT();
        }
        s1 = dh.j(((com.google.android.gms.internal.d.a) (obj)));
...
_L2:
        ...
        if ("base64".equals(s))
        {
            map = Base64.decode(s1, i);
            continue; /* Loop/switch isn't completed */
        }
        if ("base64url".equals(s))
        {
            map = Base64.decode(s1, i | 8);
            continue; /* Loop/switch isn't completed */
        } else
        {
            try
...
_L4:
        ...
        {
            map = Base64.encodeToString(map, i);
            continue; /* Loop/switch isn't completed */
        }
        ...
        map = Base64.encodeToString(map, i | 8);
