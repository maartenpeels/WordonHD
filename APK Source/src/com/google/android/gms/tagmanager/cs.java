...
class cs
{
    ...
    public cs(Context context, cq.c c1, DataLayer datalayer, s.a a1, s.a a2, ag ag1)
    {
        ...
        a(new cu());
        a(new dd());
        for (c1 = ZM.iterator(); c1.hasNext();)
        {
            datalayer = (cq.e)c1.next();
            if (ag1.kA())
            {
                a(datalayer.lq(), datalayer.lr(), "add macro");
                a(datalayer.lv(), datalayer.ls(), "remove macro");
                a(datalayer.lo(), datalayer.lt(), "add tag");
                a(datalayer.lp(), datalayer.lu(), "remove tag");
            }
            int j = 0;
            while (j < datalayer.lq().size()) 
            {
                a1 = (cq.a)datalayer.lq().get(j);
                if (ag1.kA() && j < datalayer.lr().size())
                {
                    context = (String)datalayer.lr().get(j);
                } else
                {
                    context = "Unknown";
                }
                ...
                a2.b(datalayer);
                a2.a(datalayer, a1);
                a2.a(datalayer, context);
                j++;
            }
            j = 0;
            while (j < datalayer.lv().size()) 
            {
                a1 = (cq.a)datalayer.lv().get(j);
                if (ag1.kA() && j < datalayer.ls().size())
                {
                    context = (String)datalayer.ls().get(j);
                } else
                {
                    context = "Unknown";
                }
    ...
    private by a(Map map, cq.a a1, Set set, cj cj1)
    {
        ...
        while (iterator.hasNext()) 
        {
            ...
            Object obj2 = cj1.bH((String)entry.getKey());
            obj2 = a((com.google.android.gms.internal.d.a)entry.getValue(), set, ((cl) (obj2)).e((com.google.android.gms.internal.d.a)entry.getValue()));
            if (obj2 == ZE)
            {
                return ZE;
            }
            if (((by) (obj2)).kQ())
            {
                a1.a((String)entry.getKey(), (com.google.android.gms.internal.d.a)((by) (obj2)).getObject());
            } else
            {
                flag = false;
            }
            ((Map) (obj1)).put(entry.getKey(), ((by) (obj2)).getObject());
        }
        if (!map.a(((Map) (obj1)).keySet()))
        {
            bh.w((new StringBuilder()).append("Incorrect keys for function ").append(((String) (obj))).append(" required ").append(map.kC()).append(" had ").append(((Map) (obj1)).keySet()).toString());
            return ZE;
        }
        boolean flag1;
        if (flag && map.jX())
        ...
        map = new by(map.x(((Map) (obj1))), flag1);
        if (flag1)
        {
            ZK.e(a1, map);
        }
