...
label0:
    ...
    public void b(String s, JSONObject jsonobject)
    {
        ...
        stringbuilder.append(jsonobject);
        stringbuilder.append(");");
        dw.y((new StringBuilder()).append("Dispatching AFMA event: ").append(stringbuilder).toString());
        loadUrl(stringbuilder.toString());
    }
...
label0:
        ...
        while (j1 != 0x80000000 && j1 != 0x40000000) 
        {
            j = 0x7fffffff;
...
_L4:
        ...
        dw.z((new StringBuilder()).append("Not enough space to show ad. Needs ").append(nq.widthPixels).append("x").append(nq.heightPixels).append(" pixels, but only has ").append(k).append("x").append(i1).append(" pixels.").toString());
        if (getVisibility() != 8)
        {
            setVisibility(4);
        }
