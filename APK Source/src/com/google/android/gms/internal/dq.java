...
_L2:
        ...
        obj = ((UrlQuerySanitizer) (obj)).getParameterList().iterator();
        do
        {
            uri = hashmap;
            ...
            uri = (android.net.UrlQuerySanitizer.ParameterValuePair)((Iterator) (obj)).next();
            hashmap.put(((android.net.UrlQuerySanitizer.ParameterValuePair) (uri)).mParameter, ((android.net.UrlQuerySanitizer.ParameterValuePair) (uri)).mValue);
        } while (true);
