...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 9: // '\t'
            parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusService");
            b b1 = aO(parcel.readStrongBinder());
            Uri uri;
            if (parcel.readInt() != 0)
            {
        ...
        case 14: // '\016'
            parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusService");
            b b2 = aO(parcel.readStrongBinder());
            i = parcel.readInt();
            ...
            a(b2, i, s, uri1, parcel.readString(), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 16: // '\020'
            parcel.enforceInterface("com.google.android.gms.plus.internal.IPlusService");
            parcel = a(aO(parcel.readStrongBinder()), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readString());
            parcel1.writeNoException();
            if (parcel != null)
            {
