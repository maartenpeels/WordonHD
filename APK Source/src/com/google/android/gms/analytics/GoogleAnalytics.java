...
public class GoogleAnalytics extends TrackerHandler
{
    ...
    private void cN()
    {
        if (!uY) goto _L2; else goto _L1
_L1:
        return;
_L2:
        Object obj = null;
        ApplicationInfo applicationinfo = mContext.getPackageManager().getApplicationInfo(mContext.getPackageName(), 129);
        obj = applicationinfo;
_L4:
        if (obj == null)
        {
        ...
        aa.y((new StringBuilder()).append("PackageManager doesn't know about package: ").append(namenotfoundexception).toString());
