    ...
    extends IInterface
{
        ...
        implements c
    {
            ...
            throws RemoteException
        {
            ...
            case 7: // '\007'
                parcel.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                boolean flag = getRetainInstance();
                parcel1.writeNoException();
                if (flag)
                {
                    i = 1;
            ...
            case 11: // '\013'
                parcel.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                boolean flag1 = getUserVisibleHint();
                parcel1.writeNoException();
                if (flag1)
                {
                    i = 1;
