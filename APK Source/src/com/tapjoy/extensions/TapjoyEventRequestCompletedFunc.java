...
public class TapjoyEventRequestCompletedFunc
    implements FREFunction
{

    public static final String TAG = "TapjoyEventRequestCompletedFunc";

    public TapjoyEventRequestCompletedFunc()
    {
    }
    ...
    public FREObject call(FREContext frecontext, FREObject afreobject[])
    {
        ...
        if (frecontext != null)
        {
            ...
            {
                Log.i("TapjoyEventRequestCompletedFunc", "sending TJEventRequest completed");
                ((TJEventRequest) (frecontext)).callback.completed();
            }
        }
        return null;
    }
