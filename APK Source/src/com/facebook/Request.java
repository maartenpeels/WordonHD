...
_L2:
            ...
            bufferedinputstream = new BufferedInputStream(parcelfiledescriptor);
            s1 = new byte[8192];
            i = 0;
_L4:
...
label0:
    ...
    static final void serializeToUrlConnection(RequestBatch requestbatch, HttpURLConnection httpurlconnection)
    {
        ...
        Object obj = new GZIPOutputStream(httpurlconnection);
        httpurlconnection = ((HttpURLConnection) (obj));
        if (!hasOnProgressCallbacks(requestbatch))
        {
            break MISSING_BLOCK_LABEL_261;
        }
        obj = new ProgressNoopOutputStream(requestbatch.getCallbackHandler());
        processRequest(requestbatch, null, j, url, ((OutputStream) (obj)), flag1);
        int i = ((ProgressNoopOutputStream) (obj)).getMaxProgress();
        obj = new ProgressOutputStream(httpurlconnection, requestbatch, ((ProgressNoopOutputStream) (obj)).getProgressMap(), i);
        httpurlconnection = ((HttpURLConnection) (obj));
