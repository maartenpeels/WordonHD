    ...
    implements com.facebook.widget.
{
    ...
    {
        facebookexception = new Intent();
        if (bundle == null)
        {
            bundle = new Bundle();
        }
        facebookexception.putExtras(bundle);
        FacebookDialog.handleActivityResult(val$context, val$appCall, val$appCall.etRequestCode(), facebookexception, val$callback);
    }
