...
public class AppEventsLogger
{
        ...
        implements Serializable
    {
        ...
        public final boolean equals(Object obj)
        {
            ...
            obj = (AccessTokenAppIdPair)obj;
            return Utility.areObjectsEqual(((AccessTokenAppIdPair) (obj)).accessToken, accessToken) && Utility.areObjectsEqual(((AccessTokenAppIdPair) (obj)).applicationId, applicationId);
        }
        ...
        implements Serializable
    {
        ...
        AccessTokenAppIdPair.SerializationProxyV1(String s, String s1, _cls1 _pcls1)
        {
            this(s, s1);
        }
    }
...
_L6:
        ...
        implements Serializable
    {
        ...
        AppEvent.SerializationProxyV1(String s, boolean flag, _cls1 _pcls1)
        {
            this(s, flag);
        }
    }
    ...
    static class PersistedAppSessionInfo
    {
        ...
        private static FacebookTimeSpentData getTimeSpentData(Context context1, AccessTokenAppIdPair accesstokenappidpair)
        {
            ...
            context1 = (FacebookTimeSpentData)appSessionInfoMap.get(accesstokenappidpair);
            if (context1 == null)
            {
...
_L2:
        ...
        static void saveAppSessionInformation(Context context1)
        {
            ...
            Object obj = new ObjectOutputStream(new BufferedOutputStream(context1.openFileOutput("AppEventsLogger.persistedsessioninfo", 0)));
...
label0:
        ...
        if (flushreason != null)
        {
            ...
            w.a(applicationContext).a(((Intent) (obj)));
            return;
        } else
        {
            return;
