...
_L3:
            parameterizedtype = Boolean.valueOf(false);
_L11:
...
_L2:
            ...
            if (!java/lang/String.equals(class1)) goto _L6; else goto _L5
_L5:
            ...
            if (java/lang/Number.isAssignableFrom(class2))
            {
              ...
              goto _L7
_L6:
            if (!java/util/Date.equals(class1) || !java/lang/String.isAssignableFrom(class2)) goto _L7; else goto _L8
_L8:
...
_L12:
            if (i >= j) goto _L7; else goto _L9
_L9:
            parameterizedtype = asimpledateformat[i];
            Date date = parameterizedtype.parse((String)obj);
            parameterizedtype = date;
            if (date != null) goto _L11; else goto _L10
_L10:
            i++;
              goto _L12
_L7:
    ...
    private static final class Factory.GraphObjectProxy extends Factory.ProxyBase
    {
        ...
        private Object createGraphObjectsFromParameters(CreateGraphObject creategraphobject, Object obj)
        {
            if (creategraphobject != null && !Utility.isNullOrEmpty(creategraphobject.value()))
            {
                ...
                if (java/util/List.isAssignableFrom(obj.getClass()))
                {
                    ...
                    for (obj = ((List)obj).iterator(); ((Iterator) (obj)).hasNext(); graphobjectlist.add(graphobject1))
                    {
                        Object obj1 = ((Iterator) (obj)).next();
                        graphobject1 = Factory.create();
                        graphobject1.setProperty(creategraphobject, obj1);
                    }
        ...
        private final Object proxyGraphObjectMethods(Object obj, Method method, Object aobj[])
        {
                ...
                implements ParameterizedType
            {
                ...
                _cls1()
                {
                    this$0 = Factory.GraphObjectProxy.this;
                    expectedType = class1;
                    super();
                }
            }
            ...
            {
                return Factory.coerceValueToExpectedType(((JSONObject)state).opt((String)aobj[0]), com/facebook/model/GraphObjectList, new _cls1());
            }
