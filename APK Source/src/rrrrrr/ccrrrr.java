...
import com.immersion.hapticmediasdk.controllers.MemoryMappedFileReader;
...
public class ccrrrr
{
    ...
    public static int b041504150415041504150415 = 99;
    ...
    private ccrrrr()
    {
        ...
        if (((b041504150415041504150415 + b041504150415041504150415) * b041504150415041504150415) % b041504150415041504150415() != b041504150415041504150415)
        {
            ...
            b041504150415041504150415 = 77;
        }
        super();
    }

    public ccrrrr(cccrrr cccrrr)
    {
        if (((b041504150415041504150415 + b041504150415041504150415) * b041504150415041504150415) % b041504150415041504150415 != b041504150415041504150415)
        {
            b041504150415041504150415 = b041504150415041504150415();
