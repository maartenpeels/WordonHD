...
public class AppEntry extends Activity
{
    ...
    private static final String RESOURCE_CLASS = "air.com.flaregames.wordon.R";
    ...
    private transient Object InvokeMethod(Method method, Object aobj[])
    {
        ...
        if (aobj != null)
        {
            try
            {
                method = ((Method) (method.invoke(sAndroidActivityWrapper, aobj)));
            }
            // Misplaced declaration of an exception variable
            catch (Method method)
            {
    ...
    private void InvokeWrapperOnCreate()
    {
        try
        {
            ...
            InvokeMethod(method, new Object[] {
                this, new String[] {
                    "", "", "-nodebug", boolean1.toString(), boolean2.toString()
                }
            });
            return;
        }
...
label0:
    ...
    private void launchMarketPlaceForAIR()
    {
        ...
        if (bundle != null)
        {
            try
            {
                obj = (String)bundle.get("airDownloadURL");
            }
            catch (android.content.pm.PackageManager.NameNotFoundException namenotfoundexception)
            {
    ...
    {
        ResourceIdMap resourceidmap = new ResourceIdMap("air.com.flaregames.wordon.R");
